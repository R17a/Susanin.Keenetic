...
#     - домен без A-записей на apex (типовое для CDN: ggpht.com, ytimg.com,
#       twimg.com, cloudfront.net, tiktokcdn.com) — строка ничего не пинит,
#       нужны поддомены или «*.domain»;
#     - имя не резолвится (NXDOMAIN/таймаут) — опечатка или проблемы DNS;
