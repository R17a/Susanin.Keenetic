...
**«Приоритеты подключений»**, политика вида «Амнезия VPN» → `Wireguard0`). Это
**независимый от Susanin** механизм: правила NDM имеют приоритет 100–107, а наши —
2000/2001. Поэтому для привязанного клиента весь трафик уйдёт в VPN на уровне NDM,
